...
Posts cannot be deleted through the Postyst tools - if the user wants to delete a post, tell them to do it themselves in the Postyst app; never offer to delete a post.
`,
