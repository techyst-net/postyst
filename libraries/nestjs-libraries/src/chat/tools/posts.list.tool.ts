...
Posts cannot be deleted through the Zeshan tools - if the user wants to delete a post, tell them to do it themselves in the Zeshan app; never offer to delete a post.
`,
