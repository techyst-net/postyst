...
export const chatOnlyMcpClients = {
  'Grok Bot':
    'Install the Postyst CLI with `npm install -g postiz`, then install the Postyst skill with `npx skills add gitroomhq/postiz-agent`. Ask me for my Postyst API key and set it as the POSTIZ_API_KEY environment variable before using the CLI.',
} as const;
    ...
    switch (client) {
      ...
      case 'NanoClaw':
        return {
          ...
          hint: 'Run this in your terminal, replace <group-id> with the agent group that should get Postyst.',
        };
    }
  }
        ...
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              ...
              'Connect Postyst MCP server to your client (Http streaming) to schedule your posts faster.'
            )}
          </div>
        </div>
...
const localCliSteps = [
  ...
  {
    label: 'Install the Postyst skill for your AI agent',
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder flex items-start justify-between gap-[12px]">
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              'cli_description',
              'Use the Postyst CLI to automate posting from your terminal, or install the skill to let your AI agent schedule posts for you.'
            )}
          </div>
        </div>
        <div className="flex gap-[6px] shrink-0 pt-[2px]">
  ...
  return (
    <div className="flex flex-col gap-[40px]">
      <div className="text-[14px] text-textColor leading-[1.7]">
        ...
        {t(
          'api_auth_note_line2',
          'If you are building a product that schedules posts on behalf of other Postyst users,'
        )}
        <br />
        {t(
          'api_auth_note_line3',
          ...
          <div>
            ...
            <div className="text-[13px] text-customColor18 mt-[2px]">
              {t(
                ...
                'Use Postyst API to integrate with your tools.'
              )}
            </div>
          </div>
          <div className="flex gap-[6px] shrink-0 pt-[2px]">
